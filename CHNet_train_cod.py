...
from models.CHNet import CHNet
...
def train(train_loader, model, optimizer, epoch, save_path):
    ...
    try:
        ...
        if epoch > 110:
            torch.save(model.state_dict(), save_path + 'CHNet_epoch_{}.pth'.format(epoch))
    except KeyboardInterrupt:
        print('Keyboard Interrupt: save model and exit.')
        if not os.path.exists(save_path):
            os.makedirs(save_path)
        torch.save(model.state_dict(), save_path + 'CHNet_epoch_{}.pth'.format(epoch + 1))
